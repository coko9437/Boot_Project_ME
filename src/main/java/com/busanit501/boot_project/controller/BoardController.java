...
public String registerPost(@Valid BoardDTO boardDTO,
    ...
    public String update(PageRequestDTO pageRequestDTO,
                         ...
                         BindingResult bindingResult, //BindingResult : 통과못한 이유를 알려주는 담당자
                         RedirectAttributes redirectAttributes) { // RedirectAttributes : 서버에서 화면쪽으로 데이터 전달
        ...
        if (bindingResult.hasErrors()) {
            ...
            //  현재 수정하는 화면 으로 가려면 게시글의 번호 정보가 필요함.
